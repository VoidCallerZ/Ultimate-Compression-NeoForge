...
/**
 * In 1.21.2, ArmorMaterial is a plain record — no registry needed.
 *
 * Constructor order:
 *   (int durabilityMultiplier,
 *    Map<ArmorType, Integer> defense,
 *    int enchantability,
 *    Holder<SoundEvent> equipSound,   <- SoundEvents fields are already Holder<SoundEvent>
 *    float toughness,
 *    float knockbackResistance,
 *    TagKey<Item> repairIngredient,
 *    ResourceLocation equipmentAsset) <- points to assets/<ns>/models/equipment/<path>.json
 *
 * Textures go in:
 *   assets/uc/textures/entity/equipment/humanoid/compressed_iron.png
 *   assets/uc/textures/entity/equipment/humanoid_leggings/compressed_iron.png
 */
